...
- (id)initWithHostName:(NSString *)hostName address:(NSData *)hostAddress luaCallBack:(int)luaCallBack
...
+ (SimplePing *)simplePingWithHostName:(NSString *)hostName luaCallBack:(int)luaCallBack
    // See comment in header.
{
    return [[[SimplePing alloc] initWithHostName:hostName address:nil luaCallBack:luaCallBack] autorelease];
}

+ (SimplePing *)simplePingWithHostAddress:(NSData *)hostAddress luaCallBack:(int)luaCallBack
    // See comment in header.
{
    return [[[SimplePing alloc] initWithHostName:NULL address:hostAddress luaCallBack:luaCallBack] autorelease];
}

@synthesize hostName           = _hostName;
@synthesize hostAddress        = _hostAddress;
@synthesize luaCallBack        = _luaCallBack;
