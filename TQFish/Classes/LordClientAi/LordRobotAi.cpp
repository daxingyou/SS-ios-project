...
//int * convert_jintArray(JNIEnv * env, jintArray arr, int *p)
//{
//    jint* arrTmp = env->GetIntArrayElements(arr,NULL);//得到一个指向原始数据类型内容的指针
//    jint len = env->GetArrayLength(arr);//得到数组的长度
//    //
...
/////////////////////////////////////////////////////
//// 得到一个新的机器人指针
//// robot_type 0不看别人的牌 1看别人的牌
/////////////////////////////////////////////////////
//JNIEXPORT jlong JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_createRobot
//(JNIEnv *, jclass, jint robot_type, jint user_id)
//{
//    //todo 初始化机器人，并返回机器人的指针  11111111
//    LordRobot * p_robot = (LordRobot *)malloc(sizeof(LordRobot));
//    p_robot->game.known_others_poker = robot_type;
//    p_robot->game.refer_others_poker = robot_type;
//    return (long)(p_robot);
//    //return (int)createRobot();
//    //return 0;
//}
//
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_setRobotType
//  (JNIEnv *, jclass, jlong ptr_robot, jint robot_type)
//{
//
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    p_robot->game.known_others_poker = robot_type;
//    p_robot->game.refer_others_poker = robot_type;
//}
//
///*
// * Class:     com_tongqu_service_robot_lordai_LordRobotAiBiz
//* Method:    initCard
//  * Method:    initPlayerType
//  * Signature: (III)V
//  */
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_initPlayerType
//   (JNIEnv *, jclass, jlong ptr_robot, jint up_player_type, jint down_player_type)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    p_robot->game.players[UP_PLAYER]->computer= up_player_type;
//    p_robot->game.players[DOWN_PLAYER]->computer= down_player_type;
//}
...
//// 设置发牌牌值
/////////////////////////////////////////////////////
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_initCard
//(JNIEnv * env, jclass, jlong ptr_robot, jintArray robot_cards, jintArray up_player_cards, jintArray down_player_cards)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    int * p_robot_cards = convert_jintArray(env, robot_cards, p_robot->card[0]);
//    int * p_up_player_cards = convert_jintArray(env, up_player_cards, p_robot->card[1]);
//    int * p_down_player_cards = convert_jintArray(env, down_player_cards, p_robot->card[2]);
//
//	//当前ai对象，自己的牌，上家，下家
//    initCard(p_robot, p_robot_cards,  p_up_player_cards, p_down_player_cards); //222222
//}
//
//
/////////////////////////////////////////////////////
//// 智能托管发牌牌值
/////////////////////////////////////////////////////
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_initCard_12
//(JNIEnv * env, jclass, jlong ptr_robot, jintArray robot_cards, jintArray up_player_cards, jintArray down_player_cards, jint lord_player)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    int * p_robot_cards = convert_jintArray(env, robot_cards, p_robot->card[0]);
//    int * p_up_player_cards = convert_jintArray(env, up_player_cards, p_robot->card[1]);
//    int * p_down_player_cards = convert_jintArray(env, down_player_cards, p_robot->card[2]);
//
//    initCard_2(p_robot, p_robot_cards,  p_up_player_cards, p_down_player_cards, lord_player);
//}
//
//
//
...
//// 得到机器人叫的分数
/////////////////////////////////////////////////////
//JNIEXPORT jint JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_callScore
//(JNIEnv *, jclass, jlong ptr_robot)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    //todo 这里调用dll的叫分函数
//    return callScore(p_robot); //询问每个ai对象需要叫的分值  33333
//}
//
//
/////////////////////////////////////////////////////
//// 得到机器人是否加倍
/////////////////////////////////////////////////////
//JNIEXPORT jint JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_doubleGame
//(JNIEnv *, jclass, jlong ptr_robot)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    //todo 这里调用dll的函数
//    return doubleGame(p_robot);
//}
//
//
/////////////////////////////////////////////////////
//// 得到机器人是否抢地主
/////////////////////////////////////////////////////
//JNIEXPORT jint JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_forceLord
//(JNIEnv *, jclass, jlong ptr_robot)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    //todo 这里调用dll的叫分函数
//    return forceLord(p_robot);
//}
//
//
/////////////////////////////////////////////////////
//// 得到机器人是否明牌
/////////////////////////////////////////////////////
//JNIEXPORT jint JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_showCard
//(JNIEnv *, jclass, jlong ptr_robot)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    //todo 这里调用dll的叫分函数
//    return showCard(p_robot);
//}
//
//
/////////////////////////////////////////////////////
//// 设置地主的座位号
/////////////////////////////////////////////////////
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_beLord
//(JNIEnv *env, jclass, jlong ptr_robot, jintArray pot, jint player_number)
//{
//
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    int * p_pot = convert_jintArray(env, pot,p_robot->pot);
//	//目标用户的对象，3次，
//	//底牌
//	//0: down player,  1: up player 2:自己	  以自己是参照物
//    beLord(p_robot, p_pot, player_number); //4444
//}
//
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_getPlayerTakeOutCards
//(JNIEnv *env, jclass, jlong ptr_robot, jintArray card, jint player_number)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    int * p_card = convert_jintArray(env, card,p_robot->outs);
//    getPlayerTakeOutCards(p_robot,p_card,player_number);
//}
//
///*
// * Class:     LordRobotBiz
// * Method:    getPlayerCallScore
// * Signature: (III)V
// */
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_getPlayerCallScore
//(JNIEnv * env, jclass, jlong ptr_robot, jint score, jint player_number)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    getPlayerCallScore(p_robot,score,player_number) ;
//}
//
///*
// * Class:     LordRobotBiz
...
// * Signature: (II)I
// */
//JNIEXPORT jintArray JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_takeOut
//(JNIEnv * env, jclass, jlong ptr_robot)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    int nResult = takeOut(p_robot, p_robot->outs) ;
//    if (nResult == 0)
//    {
//        return env->NewIntArray(0);
//    }
//    jintArray result = env->NewIntArray(21);
//    jint fill[21];
//    for (int i = 0; i < 21; i++)
//    {
//        fill[i] =  p_robot->outs[i];
//    }
//    env->SetIntArrayRegion(result, 0, 21, fill);
//    return result;
//}
//
//
...
//// 销毁一个机器人
/////////////////////////////////////////////////////
//JNIEXPORT void JNICALL Java_com_tongqu_service_robot_lordai_LordRobotAiBiz_destoryRobot
//(JNIEnv *, jclass, jlong ptr_robot)
//{
//    LordRobot * p_robot = (LordRobot *)ptr_robot;
//    //todo 调用dll的销毁函数
...
#define FUNC_NAME PRINTF(LEVEL,"ENTER %s",__FUNCTION__);
#if 0
#define IS_HUN(h,i)   (i == h->hun)
#define HUN_NUMBER(h)   (h->hands[h->hun])
...
#define PRE_PLAYER(game)  ( game->players[game->pre_playernum]->i_d )
...
int sort_poker(POKERS * h )
{
    ...
    for (int i=0; i<MAX_POKER_KIND; i++)
    {
        ...
        {
            res=false;
            PRINTF_ALWAYS("ERR in sort_poker: fatal, poker %d is negative",i);
        }
        h->total+=h->hands[i];
    }
...
int convert_poker_to_hun(POKERS* src, POKERS * dst, POKERS* realhand)
{
   int hun_num=0;
    ...
    if(hun_num > realhand->hands[hun])
    	{
    	    PRINTF_ALWAYS("line %d, No enough hun in real hand", __LINE__);
    	}
    sort_poker(dst);
	return hun_num;
}
...
int combo_2_poker(POKERS* hand, COMBO_OF_POKERS * h) // h must be contained by hand.
{
    ...
    case NOTHING:
        //break;
    default:
        PRINTF_ALWAYS("line %d, ERR, remove failed, this combo type %d not supported", __LINE__,h->type);
        break;
    };
...
void print_combo_poker(COMBO_OF_POKERS * h /*, COMBO_OF_POKERS *h1 /*for three*/  )
{
    ...
    case NOTHING:
        break;
    default:
        PRINTF(LEVEL,"ERR, this combo type %d not supported", h->type);
        break;
    }
    PRINTF(LEVEL," ");
}
...
void print_summary( COMBOS_SUMMARY * s)
{
    ...
    PRINTF(LEVEL,"combos %d,big %d,type %d total %d",s->combo_total_num,s->biggest_num,s->combo_typenum,s->real_total_num);
    PRINTF(LEVEL,"single %d",s->singles_num);

    PRINTF(LEVEL, "Singles: ");
...
void print_suit(PLAYER * player)
{
    ...
    PRINTF(LEVEL+1,"ctrl %d extra_ctrl %d,",player->max_control.single,s->extra_bomb_ctrl);
    PRINTF(LEVEL+1,"combos %d,big %d,type %d total %d",s->combo_total_num,s->biggest_num,s->combo_typenum,s->real_total_num);
    PRINTF(LEVEL,"single %d",s->singles_num);
    ...
    for(int i=P3; i<=BIG_JOKER; i++)
    {
        while (h.hands[i]!=0)
        {
            *p= find_and_remove_int_in_card(card,i);
            if(*p==-1)
            {
                PRINTF_ALWAYS("FUCK in line %d",__LINE__);
            }
            p++;
            h.hands[i]--;
        }
...
int is_combo(POKERS *h, COMBO_OF_POKERS * c)
{
    c->type = -1;
    if ( h->total> 0 )
    {
        ...
        case 3 :
            ...
            break;
        case 4 :
            if (h->hands[h->begin]==4) c->type =BOMB;
...
int get_opp_bomb_number(GAME* g)
{
    if(g->known_others_poker)
    {
        ...
        c=&tmp;
        if(g->players[CUR_PLAYER]->i_d == LORD)
        {
            return
			get_bomb_numbers(g->players[DOWN_PLAYER]->h)
			+get_bomb_numbers(g->players[UP_PLAYER]->h);
        }
        else    if(g->players[CUR_PLAYER]->i_d == UPFARMER)
        {
            return
			get_bomb_numbers(g->players[DOWN_PLAYER]->h);
        }
        ...
        {
            return get_bomb_numbers(g->players[UP_PLAYER]->h);
        }
    }
    else
       return 0;
...
int opp_hasbomb(GAME * g)
{
    if(g->known_others_poker)
    {
        ...
        if(g->players[CUR_PLAYER]->i_d == LORD)
        {
            if(getBomb(g->players[DOWN_PLAYER]->h,c)
                    ||getBomb(g->players[UP_PLAYER]->h,c) )
            {
                return true;
            }
            else
        ...
        {
            if(!getBomb(g->players[UP_PLAYER]->h,c))
            {
                return false;
            }
            else
    ...
    else
    {
		...
		if(getBomb(g->players[CUR_PLAYER]->opps,c))
		{
		   ...
		   if(pl->i_d == UPFARMER && pl->oppDown_num<check_num )
               {
                    return false;
               }
		   if(pl->i_d == DOWNFARMER && pl->oppUp_num<check_num )
               {
                    return false;
               }
...
#if 0
    DBG(
        PRINTF(LEVEL,"cur  high:  ");
        for (int k=j; k>=0; k--)
        print_one_poker(HighPoker[k]);
        PRINTF(LEVEL," opps  high: ");
        for (int k=j1; k>=0; k--)
...
// DBG(    print_one_poker(last);  PRINTF(LEVEL,"");      )
    ...
    j=j1>=0?j:j+1;
    if (j<0) j++;
//    PRINTF(LEVEL,"N %d M %d j %d", N,M,j);
//    if(N+j==0)
//		return 2*M-number;
...
void update_summary(GAME* game, COMBOS_SUMMARY *s, POKERS*h, POKERS * opp, COMBO_OF_POKERS * c,int total, int opp1,int opp2,int lower,PLAYER * player)
{
    ...
    PRINTF(LEVEL+1,"Combos summary: total %d type %d real_total %d biggest %d",s->combo_total_num,s->combo_typenum,s->real_total_num,s->biggest_num)	;
}
...
//    int total = s->combo_total_num;
    ...
    for (int k=0; k<total; k++)
    {
        ...
        default:
            //nothing++;
            PRINTF_ALWAYS("!!ERR, line %d this type of combo not supported : %d",c[k].type,__LINE__);
            break;
        case NOTHING:
            break;
        }
...
//地主报单农民组牌方式
int search_combos_in_suits_for_min_single_farmer(GAME* game,POKERS* h , COMBO_OF_POKERS * pCombos,PLAYER * player)
{
...
int search_combos_in_suit(GAME* game, POKERS *h , POKERS *opp, PLAYER* player )
{
    ...
    sort_all_combos(game,player->combos,number,player->summary,player->opps,player->oppDown_num
                    ,player->oppUp_num,player->lower_control_poker,player);
    //check_biggest_in_all_combos(player->combos,player->summary,opp,player->oppUp_num,player->oppDown_num);
...
{
//      game->players[CUR_PLAYER]->i_d = game->player[CUR_PLAYER].type;
//		game->players[UP_PLAYER]->i_d = game->player[UP_PLAYER].type;
//		game->players[DOWN_PLAYER]->i_d = game->player[DOWN_PLAYER].type;
...
//   COMBOS_SUMMARY *s =player->summary;
    ...
    default:
        PRINTF_ALWAYS("!!ERR,in line %d :  no such combos in player",__LINE__);
    }
    return false;
}
...
int has_control_poker(COMBO_OF_POKERS* c, int lower)
{
    ...
    if (c->len ==0)
    {
        PRINTF_ALWAYS("ERR: len of type is zero..! type %d",c->type);
        c->len=1;
    }
...
//    PLAYER *pl=game->players[CUR_PLAYER];
    ...
    if(s->real_total_num ==2  &&  s->combo_typenum == 1)
    {
        ...
        if(s->singles_num == 2)
        {
            if((pl->i_d==UPFARMER && pl->oppDown_num ==1 )
		  ||(pl->i_d==DOWNFARMER && pl->oppUp_num ==1 ))
            	{
            	    *cur =*s->singles[1];
		    return 1;
            	}
           ...
           if(( s->singles[1]->low > pl->opps->end)
        	||(game->known_others_poker && pl->i_d==UPFARMER && s->singles[1]->low > downPl->opps->end)
        	||(game->known_others_poker &&  pl->i_d==DOWNFARMER && s->singles[1]->low > upPl->opps->end)
        	)
           	{
           	    *cur =*s->singles[0];
		    return 1;
...
COMBO_OF_POKERS* check_for_win_now(GAME* game,COMBO_OF_POKERS* pre)
{
    ...
    else if(summary->combo_total_num <= 1)
    {
       if(summary->real_total_num==2 && summary->combo_total_num <= 1) //just one combo
       {
        ...
        if(pl->i_d == DOWNFARMER)
        {
            if(game->players[game->pre_playernum]->i_d == UPFARMER
        ...
        else if (0 && pl->i_d ==UPFARMER && (game->players[game->pre_playernum]->i_d == DOWNFARMER )
                 && game->players[game->pre_playernum]->summary->real_total_num == 1 )
        {
            //todo check
        ...
        if(summary->bomb_num>0 && !opp_hasbomb(game) ) //
        {
            ...
            for(; i<summary->bomb_num; i++)
                ...
                {
//                    if(pl->i_d==LORD &&
//						pl->oppDown_num >8 && pl->oppUp_num>8 && summary->real_total_num>3) //出炸弹晚一些
//                       return NULL;
//                    if(pl->i_d==UPFARMER&&
//						pl->oppDown_num >12 && summary->real_total_num>3) //出炸弹晚一些
//                       return NULL;
//                    if(pl->i_d==DOWNFARMER&&
//						pl->oppUp_num >10 && summary->real_total_num>3) //出炸弹晚一些
//                       return NULL;
                    return summary->bomb[i];
                }
        }
...
COMBO_OF_POKERS* get_combo_in_a_win_suit(GAME* game)
{
    ...
    if (num<=1+s->bomb_num  )//for bomb
    {
       ...
       if(player->i_d==LORD)
       {
		...
		if( !opp_hasbomb(game) ||
			player->i_d !=LORD
			|| (s->bomb_num ==0 && (s->ctrl.single <10 || has_big==0))
                 ...
                 for (int k=0; k<s->biggest_num; k++)
                 {
                     if (s->biggest[k]->type!=BOMB && s->biggest[k]->type!=ROCKET)//先出冲锋套
                     {
         			    ...
         			    if(is_combo_biggest_sure_without_bomb(game,&t)) //todo check this?
         			    {
                            ...
                            {
                             //查看农民是否刚好能跑
                             if(game->players[CUR_PLAYER]->i_d!=DOWNFARMER &&
         				game->players[DOWN_PLAYER]->h->total == get_combo_number(s->not_biggest[i])
                                     ...
                                     &&NOT_BOMB(c))
                                 continue;
                             if(game->players[CUR_PLAYER]->i_d!=UPFARMER &&
         				...
         				game->players[DOWN_PLAYER]->h->total == get_combo_number(s->not_biggest[i])
                             ...
                             if(game->players[CUR_PLAYER]->i_d!=UPFARMER &&
                                 ...
                                 continue;
                                    ...
                                    && game->players[CUR_PLAYER]->i_d!=UPFARMER && player->oppUp_num ==1)
                                 ||
                                 (s->not_biggest[i]->type==PAIRS
                                    && game->players[CUR_PLAYER]->i_d!=UPFARMER && player->oppUp_num ==2)
                                 ||(s->not_biggest[i]->type==SINGLE
                                    && game->players[CUR_PLAYER]->i_d!=DOWNFARMER&& player->oppDown_num==1)
                                 ||
                                 (s->not_biggest[i]->type==PAIRS
                                    && game->players[CUR_PLAYER]->i_d!=DOWNFARMER && player->oppDown_num ==2)
                                    )
								{
								continue;
								}
...
COMBO_OF_POKERS* farm_select_combo_in_suit(GAME* game)
{
    ...
    if(s->combo_total_num ==2)
    {
	  ...
	  if(number==2 && s->bomb_num==0 && s->ctrl.single < 10 )
	  {
             for (int k=0; k<s->biggest_num; k++)
            {
                return s->biggest[k];
...
__CHONGFENG:
    ...
    if (t==NULL)
    {
        PRINTF_ALWAYS("ERR: line %d lord play first: stupid error",__LINE__);
        return;
    }
...
__SEARCH_BOMB_FOR_SINGLE:
    ...
    //顺牌
    COMBO_OF_POKERS tmp,*p =&tmp;
    memmove(p,pre,sizeof(COMBO_OF_POKERS)); //todo: optimize this
    int good_bomb=0;
...
//   {
    ...
    if (t==NULL)
    {
        PRINTF_ALWAYS("ERR: line %d up farmaer play first: stupid error",__LINE__);
        return;
    }
    *cur=*t;
}
...
void farmer_select_one_combo_for_other_farmer(GAME* game,PLAYER* pl,COMBO_OF_POKERS* cur,int isup)
{
    ...
    PRINTF(LEVEL,"ENTER Fun farmer_select_one_combo_for_other_farmer: up %d"	,isup);
        ...
        while ( find_a_bigger_combo_in_hands(player->h,c,p)) //could not handle corner case for  BOMB in two combos.
        {
	     ...
	     add_poker(player->h,&t,player->h);
	      if( c->type == ROCKET||c->type==BOMB)
			...
			{
			      PLAYER *lord= player->i_d==UPFARMER?
				  	                game->players[DOWN_PLAYER] :
				  	                game->players[UP_PLAYER];
	 ...
	 //int prob2 = get_prob_2(game);
        while ( find_a_bigger_combo_in_hands(player->h,&tmp1,p)) //could not handle corner case for  BOMB in two combos.
        {
            ...
            *suit1->opps=*player->opps;
			...
			//update player in hands;
            PRINTF(LEVEL,"!farmer biguan, new_combo_num %d, new_ctrl %d pre_ctrl %d, pre_combo_num %d"
        ...
        //}
        free(suit1);
		//research players for other function
		//todo: remove this
	if(!first_time)
            search_combos_in_suit(game,player->h,player->opps,player);
        return first_time;
...
int must_play_bigger_for_single(COMBO_OF_POKERS * cur, PLAYER* player,COMBO_OF_POKERS *pre,GAME * game,int isup, int isgood,int isfarmer)
{
    ...
    if ( c==NULL) {
        ...
        while ( find_a_bigger_combo_in_hands(player->h,c,p))
        {
            ...
            //update player in hands;
            DBG( PRINTF(LEVEL,"!farmer biguan, new_combo_num %d, new_ctrl %d pre_ctrl %d, pre_combo_num %d"
                        ,suit1.summary->combo_total_num ,CONTROL_NUM(&suit1) ,CONTROL_NUM(player), player->summary->combo_total_num
                       ));
            if ( first_time
...
SAVE_CUR_RESULT:
	PRINTF(LEVEL,"!farmer chaipai,  control-combo %d combo_num %d, old( %d,%d)"
					  ,CONTROL_SUB_COMBO_NUM(&tmp_player),tmp_player.summary->combo_total_num,
					  CONTROL_SUB_COMBO_NUM(player), player->summary->combo_total_num
					 );
	print_combo_poker(c);
...
int farmer_play_when_lord_has_1_poker_only(COMBO_OF_POKERS* cur, COMBO_OF_POKERS* pre, PLAYER*player, GAME*game, int isup,int isgood)
{
    FUNC_NAME
    SET_PLAYER_POINT(game);
    if (game->players[game->pre_playernum]->i_d == LORD && pre->type != SINGLE)
    {
        //地主报单农民必管逻辑
    ...
    else
    {
        if ( pre->type == SINGLE)
        {
            ...
            //如果该牌为外面最大.. 则过牌？
            if ( game->players[game->pre_playernum]->i_d == DOWNFARMER
			&&( pre->low >= lord_single )
			   )
            {
                return 1;
...
void farmer_play_first_lord_has_1_poker_only( GAME*game,COMBO_OF_POKERS* cur,int is_good_farmer, PLAYER*player, int isup)
{
    ...
    if( game->known_others_poker )
    {
                ...
                || second_single >= lord_single ) //self will win!
        {
            ...
            {
                PRINTF_ALWAYS("line %d stupid error happens...",__LINE__);
            }
        }
            ...
            for(int i=0; i<s->biggest_num; i++)
            {
                if(!get_num_of_smaller(lord->combos,MAX_COMBO_NUM,s->biggest[i]))
                {
                    if(s->biggest[i]->type == SINGLE_SERIES )
                        return s->biggest[i];
                    if(!has_control_poker(s->biggest[i], player->lower_control_poker))
                        return s->biggest[i];
                }
            }
        }
...
void upfarmer_play_first(GAME* game, COMBO_OF_POKERS* cur)
{
    ...
    if ( is_good_farmer) {
        ...
        if(res==NULL)
        {
            PRINTF(LEVEL,"ERR stupid error @ line %d",__LINE__);
        }
        else
            *cur=*res;
    }
...
int must_play_for_poker2(GAME * game,COMBO_OF_POKERS * cur, PLAYER* player,COMBO_OF_POKERS *pre, int check_opps_lit_joker)
{
    ...
    if ( player->h->hands[LIT_JOKER]==1 )
    {
        ...
        {
            if(player->good_framer  || player->i_d == DOWNFARMER ) //不拆大小王
                return 1;
        ...
        else  //bad
        {
            if ( PRE_PLAYER(game)  == LORD
                    ...
                    ( (pre->type!=SINGLE  && pre->type!=PAIRS )
                       || (pre->type == SINGLE &&
                            pre->low<game->players[CUR_PLAYER]->lower_control_poker)
                       //|| (pre->type == PAIRS && pre->low<player->lower_control_poker-2)
			)
                    )
            {
                return true;
...
int upfarmer_make_a_bigger_for_single_and_pair(GAME *game,COMBO_OF_POKERS* pre, COMBO_OF_POKERS* cur,int is_good)
{
    ...
    if ( (pre->type == SINGLE ))
    {
        ...
        if (!is_good && pre->low < geying)
        {
            ...
            if ( game->players[game->pre_playernum]->i_d !=LORD
...
//pre player is lord.)
   ...
   //biguan
...

    {
        ...
        {
            if ( (game->players[game->pre_playernum]->i_d == LORD  ) //pre player is lord.
                    && ( get_combo_number(pre)>=3 ) )
            {   //必管..
                pass=must_play_bigger(cur,player,pre,game,0,is_good_farmer,1);
            }
            else if ((game->players[game->pre_playernum]->i_d == LORD  ) //pre player is lord.
                     && (pre->type == SINGLE && pre->low>=P2 && pre->low<BIG_JOKER))
            {
                pass=must_play_for_poker2(game,cur,player,pre,0);
            }
            else if ((game->players[game->pre_playernum]->i_d == LORD  ) //pre player is lord. //pre's type is single or pair
                    )
            {
...
int check_farmer_is_good(GAME* game)
{
    ...
    if ( ( game->players[CUR_PLAYER]->oppUp_num == 1 &&  game->players[UP_PLAYER]->i_d  == LORD )
            ||( game->players[CUR_PLAYER]->oppDown_num == 1 && game->players[DOWN_PLAYER]->i_d  == LORD ) )
...
//update for robot[1]
    ...
    robot[1]->game.player_type = robot[1]->game.players[CUR_PLAYER]->i_d;
...
//update for robot[2]
    ...
    robot[2]->game.player_type = robot[2]->game.players[CUR_PLAYER]->i_d;
/*
...
//		DUMP_GAME_FOR_PLAYER(robot[2]);
        pass1=takeOut(robot[0],outs[0]);
        getPlayerTakeOutCards(robot[1],outs[0],1);
        getPlayerTakeOutCards(robot[2],outs[0],0);
        winner=CUR_PLAYER;
...
game_turn_p2:
        ...
        //DUMP_GAME_FOR_PLAYER(robot[1]);
        pass1=takeOut(robot[1],outs[0]);
        getPlayerTakeOutCards(robot[2],outs[0],1);
        getPlayerTakeOutCards(robot[0],outs[0],0);
        winner=DOWN_PLAYER;
        if(robot[1]->game.players[2]->h->total==0) //game over
            break;
game_turn_p3:
        //DUMP_GAME_FOR_PLAYER(robot[2]);
        pass1=takeOut(robot[2],outs[0]);
        getPlayerTakeOutCards(robot[0],outs[0],1);
        getPlayerTakeOutCards(robot[1],outs[0],0);
        winner=UP_PLAYER;
    ...
    PRINTF(LEVEL,"winner is player %d",winner);
    PRINTF(LEVEL,"===========END   CHECK WIN===============");
    int res =0;
    if(winner==CUR_PLAYER ||
            (robot[0]->game.players[CUR_PLAYER]->i_d!=LORD
             && robot[0]->game.players[winner ]->i_d!=LORD)
      )
        res=1;
...
typedef struct {
    PLAYER_TYPE i_d;//current player
    POKERS p;
} POKER_AND_TYPE;
...
//	 num+=search_general_3(&tmp, combos+num, 0,0,0,0);
        ...
        PRINTF(LEVEL, "test combos %d: ",num );
...
// /*
    PRINTF(LEVEL,"TESTing NODE VALUE: %d, type %d Combo ",t->value,t->h->i_d);
    if(t->c.type!=NOTHING)
...
//*/
    ...
    {
        PRINTF(LEVEL,"DONE, %d win",t->h->i_d);
        t->value = 1;
    ...
    else
    {
        ...
        for( int i=0; i<loop; i++)
        {
            ...
            if( t->h->i_d !=  DOWNFARMER ) //child is UPFARMER
                value = -value;
    ...
    // PRINTF(LEVEL,"NODE VALUE: %d, type %d Combo ",t->value,t->h->i_d);
//   if(t->c.type!=NOTHING)
//  print_combo_poker(&t->c);
//   PRINTF(LEVEL,"");
    if(t->c.type!=NOTHING)
...
int get_the_best_hand_2(GAME *game,  COMBO_OF_POKERS * cur,bool first)
{
    ...
    p[1].i_d= game->players[DOWN_PLAYER]->i_d;
    p[2].p= *game->players[UP_PLAYER]->h;
    p[2].i_d= game->players[UP_PLAYER]->i_d;
    ...
    *cur = top.childs[max_value_item].c;
    ...
    {
        if(first ==1) PRINTF_ALWAYS("line %d, fatal error, must play some cards..", __LINE__);
        return 1;
    }
}
...
int get_the_best_hand(GAME *game,  COMBO_OF_POKERS * cur,bool first)
{
    ...
    for(int i=0; i<cv_num; i++)
    {
        if(cv[i].c.type!=NOTHING)
        {
            ...
            PRINTF(LEVEL,"");
            if(pl->h->total!=0)
                //to optimize: now always re-search
                search_combos_in_suit(game,pl->h,pl->opps,pl);
        }
//                else
        //              break;
        ...
        int winner = 0;
        if(pl->h->total!=0)
            winner=Check_win_quick(game, DOWN_PLAYER,1,0,0);
        else
            winner = 1;
        ...
        else if(pl->i_d != LORD && game->players[winner]->i_d!=LORD)
        {
            cv[i].val=100;
        }
        else
        ...
        if(cv[i].c.type!=NOTHING)
        {
            game->pre = pre;
            POKERS tmp;
            combo_2_poker(& tmp, &cv[i].c);
            add_poker(pl->h,&tmp,pl->h);
        }
        if(cv[i].val>0)
            break;
    }
...
COMPUTER_PLAY :
            ...
            else// farmer's trun
            {
                ...
                int isup = game->player_type == UPFARMER;
                //       DBG( PRINTF(LEVEL,"game firsthalf %d ： %s %s farmer",game->is_first_half_game,is_good_farmer?"good":"bad",isup?"up":"down"));
                if (first) //zhudong chupai
                {
                    if (isup )
                    {
        ...
        PRINTF(VERBOSE,"====       Current Hands      ====         ");//, UP_PLAYER );
        //log_brief =1;
        //log_brief=0;
        return pass;
    }
...
int is_game_first_half(GAME* game,int player)
{
    if ( ( game->players[CUR_PLAYER]->oppUp_num <=10 && game->players[UP_PLAYER]->i_d == LORD )
            ||( game->players[CUR_PLAYER]->oppDown_num <= 10 && game->players[DOWN_PLAYER]->i_d == LORD ) )
        return 0;
...
void initCard(LordRobot* robot, int* robot_card, int* up_player_card, int* down_player_card)
{
    ...
    //  if (!set->cus) //rand
    {
        ...
        game->players[DOWN_PLAYER]->card[17]=-1;
        game->players[CUR_PLAYER]->card[17]=-1;
        game->players[UP_PLAYER]->card[17]=-1;
    }
...
//	 	break;
        ...
        if(j!=3)
        {
            PRINTF(LEVEL,"line %d: FATAL ERROR in initCard",__LINE__);
            j=3;
        }
        game->pot_card[j]=-1;
    }
    ...
    PRINTF(LEVEL,"current PLAYER Hands: ");
...
//not a full game
void initCard_2(LordRobot* robot, int* robot_card, int* up_player_card, int* down_player_card,int player_number/*who is lord */)
{
#if 1
    //todo: save some code...
    GAME *game=&robot->game;
...
//	game->all.hun = laizi;
    ...
    add_poker(game->players[CUR_PLAYER]->h,
		game->players[UP_PLAYER]->h, &all);
    add_poker(game->players[DOWN_PLAYER]->h,
		&all, &all);
...
//    full_poker(&game->all);
    ...
    game->players[1]->cur=NULL;
//    log_brief =0;
    game->players[CUR_PLAYER]->oppDown_num = game->players[DOWN_PLAYER]->h->total;
    game->players[CUR_PLAYER]->oppUp_num = game->players[UP_PLAYER]->h->total;

    game->players[DOWN_PLAYER]->oppDown_num = game->players[UP_PLAYER]->h->total;
    game->players[DOWN_PLAYER]->oppUp_num = game->players[CUR_PLAYER]->h->total;

    game->players[UP_PLAYER]->oppDown_num = game->players[CUR_PLAYER]->h->total;
    game->players[UP_PLAYER]->oppUp_num = game->players[DOWN_PLAYER]->h->total;
...

{
    ...
    if(player_number == 2)
    {
        ...
        game->players[CUR_PLAYER]->i_d=LORD;
        game->players[DOWN_PLAYER]->i_d=DOWNFARMER;
        game->players[UP_PLAYER]->i_d=UPFARMER;
        game->player_type = (PLAYER_TYPE)game->players[CUR_PLAYER]->i_d;
        if(game->init==0)
        {
            game_init(game);
            game->init=1;
        }
        game->rec.type[CUR_PLAYER] = game->players[CUR_PLAYER]->i_d;
        game->rec.type[DOWN_PLAYER] = game->players[DOWN_PLAYER]->i_d;
        game->rec.type[UP_PLAYER] = game->players[UP_PLAYER]->i_d;
        return;
    }
    GAME *game=&robot->game;
    ...
    {
        game->players[CUR_PLAYER]->i_d  = DOWNFARMER;//robot
        game->players[DOWN_PLAYER]->i_d  = UPFARMER;
        game->players[UP_PLAYER]->i_d = LORD;
    }
    else if	(player_number==DOWN_PLAYER)
    {
        game->players[DOWN_PLAYER]->i_d = LORD;
        game->players[UP_PLAYER]->i_d= DOWNFARMER;
        game->players[CUR_PLAYER]->i_d = UPFARMER;
    }
...
int callScore(LordRobot* robot)
{
    ...
    if(game->known_others_poker)
    {
        ...
        if(winner)
        {
            PRINTF(LEVEL,"robot %x could win!!",robot);
            score = 3;
        }
        else
        {
            PRINTF(LEVEL,"robot %x would lose!!",robot);
                    ...
                    && game->players[DOWN_PLAYER]->score == 0 /*Un called*/)
            {
                ...
                PRINTF(LEVEL,"robot %x would lose, but should be lord since player will win!!",robot);
...
void getPlayerTakeOutCards(LordRobot* robot,int* poker, int player_number)
{
    ...
    if (poker[0]!=-1)
    {
        ...
        PRINTF(VERBOSE,"itr@game[%x] %d",game,game->rec.now);
        ...
        if(!i)
            PRINTF_ALWAYS("fatal erro line %d!",__LINE__);
    ...
    {
        PRINTF(VERBOSE,"itr@game[%x] %d PASS",game,game->rec.now);
...
int  doubleGame(LordRobot* robot)
{
  ...
  int lord=game->call.cur_lord;
	...
	if(game->known_others_poker)
	{
	    ...
	    LordRobot tR;
           Robot_copy(&tR,robot);
    	    PRINTF(LEVEL,"=============START DOUBLEGAME %d=============",player_pos);
...
int forceLord(LordRobot* robot)
{
   ...
   for(int i=0;i<game->call.cur_num;i++)
	...
	if(game->known_others_poker)
	{
	    ...
	    LordRobot tR;
           Robot_copy(&tR,robot);
    	    PRINTF(LEVEL,"=============START LORD %d=============",player_pos);
		if(player_pos==DOWN_PLAYER)
		{
		    POKERS tmph= *tR.game.players[CUR_PLAYER]->h;
		    POKERS tmpopps= *tR.game.players[CUR_PLAYER]->opps;
...
//	game->cur_playernum = 2;
    ...
    static int turn = 0;
    DBG(
        PRINTF(LEVEL,"==START_OF_ROBOT_PLAY TURN %d==",turn);
    )
    ...
    if(!pass) {
        ...
        PRINTF(VERBOSE,"itr@game[%x] own %d",game,game->rec.now);
    ...
    /*
        ...
        //*/
    DBG(
        PRINTF(LEVEL,"==END_OF_ROBOT_PLAY TURN %d==",turn++);
    )
...
void dump_game_record(RECORD *rec)
{
    ...
    PRINTF(LEVEL,"===   LORD is  %s    ===", rec->lord==CUR_PLAYER? "CUR_PLAYER" :
           (rec->lord==DOWN_PLAYER? "DOWN_PLAYER" : "UP_PLAYER") );

    PRINTF(LEVEL,"===   CUR_PLAYER is  %s    ===",TYPE[ rec->type[CUR_PLAYER]]);
...
void DUMP_GAME_FOR_PLAYER(LordRobot * r)
{
    ...
    {
        //clrscr();
        PRINTF(LEVEL,"+-----------Current game------------+");
        PRINTF(LEVEL,"control poker since %c",poker_to_char(game->lowest_bigPoker));
        PRINTF(LEVEL,"|CurPLAYER [%10s] [%s] Hands: ", TYPE[game->player_type], game->computer[0]?"Computer":"Human   ");
	...
	PRINTF(LEVEL,"");
       ...
       //     PRINTF(LEVEL,"Turn of Player%d [%s]", CUR_PLAYER,game->lord==CUR_PLAYER+1?"lord  ":"farmer");
...
int lord=0;
    if (set->cus)
    {
        if (set->cus==2)
        {
            ...
            set->computer[0] = game->computer[CUR_PLAYER];
            set->computer[1] = game->computer[DOWN_PLAYER];
            set->computer[2] = game->computer[UP_PLAYER];
        }
        else {
            //printf("select lord:");
            scanf("%d",&lord);
    ...
    if (lord==DOWN_PLAYER) {
        game->players[0]->i_d = LORD;
        game->players[1]->i_d = DOWNFARMER;
        game->players[2]->i_d = UPFARMER;
        //    game->players[1]->oppDown_num = 0;
        //   game->players[2]->oppUp_num = 0;
    }
    else if (lord==UP_PLAYER) {
        game->players[1]->i_d = LORD;
        game->players[2]->i_d = DOWNFARMER;
        game->players[0]->i_d = UPFARMER;
        //    game->players[2]->oppDown_num = 0;
        //    game->players[0]->oppUp_num = 0;

    }
    else if (lord==CUR_PLAYER) {
        game->players[2]->i_d = LORD;
        game->players[0]->i_d = DOWNFARMER;
        game->players[1]->i_d = UPFARMER;
    ...
    game->player_type = game->players[CUR_PLAYER]->i_d;

//    return 1;
}

void arrange_poker(LordRobot * robot[3],int *pot,int laizi)
{
    for (int k=0; k<54; k++)
    {
        all_cards[k]=1;
...
// if (!set.cus) //rand
    {
        for (int k=0; k<17; k++)
        {
            cards[0][k]= rand_a_card(all_cards);
            cards[1][k]= rand_a_card(all_cards);
            cards[2][k]= rand_a_card(all_cards);
        }
        for (int k=0; k<3; k++)
        {
...
void arrange_poker_from_file(LordRobot * robot[3],int *pot)
{
    for (int k=0; k<54; k++)
    {
        all_cards[k]=1;
...
//int user_play(LordRobot* robot,int * p)
//{
//     #if 1
//	      GAME * game = &robot->game;
//             char buf[100];
...
//    for_test = 1;
//    set.cus=0;
//    //printf(" == DouDiZhu Algorithm Test (VER: %s) Powered By ZZF ==",VER);
...
//
//    //printf("player 0 is %s",set.computer[0]?"COM":"HUMAN");
//    //printf("player 1 is %s",set.computer[1]?"COM":"HUMAN");
//    //printf("player 2 is %s",set.computer[2]?"COM":"HUMAN");
//
//    fflush(stdin);
//    if(argc>1)
//        end=8;
...
//    if(end!=6)
//    {
//        //printf("Begin game %d ,log to %d.txt and brief_%d.txt ",seed,seed,seed);
...
//
//    log_brief=1;
//    PRINTF(LEVEL,"MAIN: === GAME %d start (VER: %s)===",seed,VER);
//    log_brief=0;
//
//
//	if(logfile!=NULL)
...
//        }
//
//       arrange_poker_from_file(robot,pot);
//	   fclose(set.input);
//    }
//    else
//    	{
//    	  //laizi=rand()%13;
//	//	  //printf("laizi is %d",laizi);
//         arrange_poker(robot,pot,0);
//    	}
//
//    //determine_lord
//    lord = determine_lord(robot);
//
//    PRINTF(LEVEL,"MAIN: === LORD is %d===",lord);
//
...
//                pass1=takeOut(robot[0],outs[0]);
//            else
//                pass1 = user_play(robot[0],outs[0]);
//
//            getPlayerTakeOutCards(robot[1],outs[0],1);
//            if(!pass1)
//            {
...
//                pass1=takeOut(robot[1],outs[0]);
//            else
//                pass1 = user_play(robot[1],outs[0]);
//
//            getPlayerTakeOutCards(robot[2],outs[0],1);
//            getPlayerTakeOutCards(robot[0],outs[0],0);
//            if(!pass1)
...
//                pass1=takeOut(robot[2],outs[0]);
//            else
//                pass1 = user_play(robot[2],outs[0]);
//            getPlayerTakeOutCards(robot[0],outs[0],1);
//            getPlayerTakeOutCards(robot[1],outs[0],0);
//            if(!pass1)
//            {
...
//
//    game_played	++;
//    //printf("lord wins %d in %d games",lord_win,game_played);
//    log_brief=1;
//    PRINTF(LEVEL,"=== GAME %d Finished (Ver: %s)===",seed,VER);
//    log_brief=0;
//
//    fflush(logfile);
//    fflush(logfile2);
