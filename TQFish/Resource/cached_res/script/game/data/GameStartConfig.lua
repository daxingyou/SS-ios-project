...
function GameStart()
	...
	CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile(Common.getResourcePath("outgame_public.plist"))
	CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile(Common.getResourcePath("scattered.plist"))
	CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile(Common.getResourcePath("nine.plist"))
	CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile(Common.getResourcePath("background.plist"))
	CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile(Common.getResourcePath("outgame_main.plist"))
...
function addChildForScene(view)
	if (CCDirector:sharedDirector():getRunningScene() == nil) then
		...
		backGroundSprite = CCSprite:createWithSpriteFrameName("MJ_Thehall_Background.png")
