...
function LoginController:addCallback()
	...
	framework.bindEventCallback(cocostudio.getComponent(LoginLogic.view,"Button_login_close"), LoginLogic.callback_Button_login_close, BUTTON_CLICK, BUTTON_SOUND_CLICK + BUTTON_ANIMATION_ZOOM_OUT);
end
...
function LoginController:removeCallback()
	...
	framework.unbindEventCallback(cocostudio.getComponent(LoginLogic.view,"Button_login_close"), LoginLogic.callback_Button_login_close, BUTTON_CLICK, BUTTON_SOUND_CLICK + BUTTON_ANIMATION_ZOOM_OUT);
end
...
function LoginController:wakeModule()
	...
	LoginLogic.setEditorEnable(true) --屏蔽输入框
end
