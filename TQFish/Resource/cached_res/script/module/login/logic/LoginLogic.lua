...
local function initLayer()
	CCSpriteFrameCache:sharedSpriteFrameCache():addSpriteFramesWithFile(Common.getResourcePath("MJ_login.plist"))
	local gui = GUI_LOGIN;
...
local function initView()
	...
	Label_imei:setText(Common.getImei());
...
function releaseData()
	CCSpriteFrameCache:sharedSpriteFrameCache():removeSpriteFramesFromFile(Common.getResourcePath("MJ_login.plist"))
end
