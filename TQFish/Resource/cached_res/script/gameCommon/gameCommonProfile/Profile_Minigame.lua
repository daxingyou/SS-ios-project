...
function createMiniGame()
	...
	if GameConfig.GAME_ID == GamePub.LORD_GAME_ID then
		...
		FishGameTable.MiniGameIconUrl = "minigame_fish_lord_v2.png";
		...
		JinHuaGameTable.MiniGameIconUrl = "minigame_zjh_lord_v2.png"
		...
		MillionNiuNiuGameTable.MiniGameIconUrl = "minigame_bainiu_lord_v2.png"
		...
		HhmfTable.MiniGameIconUrl = "minigame_hhmf_lord_v2.png"
